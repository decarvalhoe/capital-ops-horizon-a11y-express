...
test('identifiants avec guillemet, crochet, barre oblique inverse : aucun plantage, étiquettes reconnues, diagnostic conservé', () => {
  ...
  assert.ok(label && label.count === 1, JSON.stringify(r));   // seul le champ sans étiquette est signalé
});
test('propriété DOM labels prioritaire quand disponible', () => {
